...
## I'm gonna create a dictionary of key pairs values to have the names of numbers written and in number to automatise the operations
numbers_dict = {
    'zero': 0,
    'one': 1,
    'two': 2,
...
#I'm creating a lambda function as a value of two differents keys identifying the possible operations
...
#Conditional statement to perform the operation, and return some error if some input is wrong.

if (a in numbers_dict and  b in sumorsubs and  c in numbers_dict):
    print(a,b,c,sumorsubs[b](numbers_dict[a], numbers_dict[c]))
else:
    print(a,b,c,"error, remember:  a = a number in written form,b = plus or minus (Exactly) and c = a number in written form (not as a # [i.e: 2]) ")
