...
st.markdown("# Breast Cancer Analysis")   ## Main Title
...
x_axis = st.sidebar.selectbox("X-Axis(Horizontal)", measurements)
y_axis = st.sidebar.selectbox("Y-Axis(Vertical)", measurements, index=1)
...
if x_axis and y_axis:
    ...
    benign_df.plot.scatter(x=x_axis, y=y_axis, s=120, c="dodgerblue", alpha=0.6, ax=scatter_ax,title="{} vs {}".format(x_axis.capitalize(), y_axis.capitalize()), label="Benign");
